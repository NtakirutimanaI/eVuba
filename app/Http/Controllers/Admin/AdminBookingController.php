...
class AdminBookingController extends Controller
{
    ...
    {
        // If a string like "report" is passed → redirect to report page
        if (!is_numeric($id)) {
            return redirect()->route('admin.bookings.report');
        }

        // Otherwise simply redirect to index (show page is not used in your system)
