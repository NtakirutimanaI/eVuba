...
<div class="dashboard-wrapper">
    <div class="pro-header">
        <div>
            ...
            <p style="color: var(--secondary); margin: 5px 0 0;">Resolve customer inquiries and technical support
                tickets.</p>
        </div>
        <div class="header-actions">
            <div class="glass-panel"
                ...
                <div class="stat-item">
                    ...
                    <strong
                        style="display: block; font-size: 1.1rem; color: var(--primary);">{{ $tickets->total() }}</strong>
                </div>
            </div>
        </div>
    </div>
    ...
    <div style="margin-top: 3rem;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            ...
            <div class="mega-search" style="max-width: 300px; flex: 1; background: var(--light);">
                ...
                <input type="text" id="supportSearch" placeholder="Find inquiry..." class="search-input"
        ...
        <div class="support-grid">
            @forelse($tickets as $ticket)
                <div class="support-card support-row">
                    <div class="card-top">
                        ...
                        <span
                            class="urgency-label {{ $ticket->priority }}">{{ strtoupper($ticket->priority ?? 'Low') }}</span>
                    </div>
                    ...
                    <div class="card-bottom">
                        <div class="category-tag"><i class="fas fa-tag"></i> {{ $ticket->category->name ?? 'General' }}
                        </div>
            ...
            @empty
                <div
                    style="grid-column: 1 / -1; text-align: center; padding: 100px 0; background: var(--white); border-radius: 30px; border: 1px dashed var(--glass-border);">
                    <i class="fas fa-inbox"
                        style="font-size: 4rem; color: var(--secondary); opacity: 0.1; margin-bottom: 20px; display: block;"></i>
    ...
    <div class="pro-modal" style="max-width: 800px; display: flex; flex-direction: column; height: 90vh;">
        <div class="modal-header">
            <div>
                ...
                <span id="modalMeta" style="font-size: 0.8rem; color: var(--secondary);">#TCK-00000 | From: Client
                    Name</span>
            </div>
            <button class="close-modal" onclick="closeTicket()">&times;</button>
        </div>

        <div class="modal-body chat-container" id="chatStream"
            style="flex: 1; overflow-y: auto; background: var(--light); padding: 25px; display: flex; flex-direction: column; gap: 20px;">
            {{-- Original Message --}}
        ...
        <div class="modal-footer"
            style="padding: 25px; background: var(--white); border-top: 1px solid var(--glass-border);">
            <form id="replyForm" style="width: 100%; display: flex; gap: 15px; align-items: flex-end;">
                <input type="hidden" id="replyTicketId">
                <div style="flex: 1; display: flex; align-items: center; background: var(--light); border-radius: 20px; border: 1px solid var(--glass-border); padding: 5px 15px; transition: 0.3s;"
                    id="inputContainer">
                    <i class="far fa-comment-dots" style="color: var(--secondary); margin-right: 10px;"></i>
                    <textarea id="replyMessage" placeholder="Compose your response..."
                        style="flex: 1; padding: 12px 0; border: none; background: transparent; font-family: inherit; resize: none; min-height: 48px; max-height: 150px; outline: none; font-size: 0.95rem; color: var(--dark);"
                        rows="1" required></textarea>
                </div>
                <button type="submit" class="send-btn"
                    style="width: 54px; height: 54px; border-radius: 20px; background: var(--primary); color: white; border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: 0 10px 20px rgba(99, 102, 241, 0.2);">
...
<style>
    ...
    #replyMessage:focus+#inputContainer {
        border-color: var(--primary);
