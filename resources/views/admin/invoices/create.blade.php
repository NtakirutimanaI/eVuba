...
<button class="save-btn" onclick="savePDF()">Save Invoice as PDF</button>
</div>
</div>
...
function openInvoice() {
    ...
    let body = document.getElementById('invoiceItems'); body.innerHTML='';
    let subtotal = 0;
    let index = 1;
    Object.values(items).forEach(i=>{
        ...
        body.innerHTML += `<tr>
            ...
            <td style="text-align:right;">${i.price.toLocaleString()} RWF</td>
            <td style="text-align:right;">${t.toLocaleString()} RWF</td>
        </tr>`;
        index++;
    });
    let tax = Math.round(subtotal * 0.18);
    ...
    document.getElementById('iSub').innerText = subtotal.toLocaleString() + " RWF";
    document.getElementById('iTax').innerText = tax.toLocaleString() + " RWF";
    document.getElementById('iGrand').innerText = grand.toLocaleString() + " RWF";
