            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="name" class="glass-input" placeholder="e.g. Premium Consulting" value="{{ old('name', $service->name) }}" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <textarea name="description" class="glass-input textarea" placeholder="Describe the service details..." rows="4">{{ old('description', $service->description) }}</textarea>
                    </div>
                </div>
            ...
            <div class="form-section">
                ...
                <div class="file-upload-wrapper">
                    ...
                    <div class="file-label">
                        ...
                        <span id="fileName">Click to change cover image</span>
                    </div>
                </div>
            </div>
...
@media (max-width: 768px) {
    .edit-service-wrapper { margin-left: 0; padding: 20px; }
}
</style>
