                        ...
                        <tr data-status="{{ $task->status }}" data-employee="{{ $task->employee_id ?? '' }}">
                            ...
                            <td>
                                <select class="priority-select" onchange="updatePriority({{ $task->id }}, this.value)">
                                    ...
                                    <option value="medium" {{ ($task->priority ?? 'medium') == 'medium' ? 'selected' : '' }}>
                                        Medium</option>
                                    <option value="high" {{ ($task->priority ?? 'medium') == 'high' ? 'selected' : '' }}>High
                                    </option>
                                    <option value="urgent" {{ ($task->priority ?? 'medium') == 'urgent' ? 'selected' : '' }}>
                                        Urgent</option>
                                </select>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <button class="btn-action view" onclick="viewTask({{ $task->id }})"
                                        title="View Details">
        ...
        <form id="taskForm">
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="taskDescription" rows="3"
                    placeholder="Task description and details..."></textarea>
            </div>
