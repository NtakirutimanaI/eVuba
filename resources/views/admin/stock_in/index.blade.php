                ...
                <div class="row-group">
                    <div class="col-half">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="number" name="quantity" id="addQty" required min="1"
                    ...
                    <div class="col-half">
                        ...
                        <div class="input-icon-wrapper">
                            <span
                                style="position: absolute; left: 12px; top: 50%; transform: translateY(-50%); color: var(--text-muted); font-size: 10px; font-weight: 800;">FRW</span>
                            <input type="number" name="unit_cost" id="addCost" required step="0.01"
                                oninput="calculateTotal('add')">
                        </div>
                    </div>
                </div>
        ...
        <div class="right-panel">
            ...
            <div class="toolbar-glass">
                ...
                <form action="{{ route('admin.stock_in.index') }}" method="GET" class="filter-form">
                    ...
                    <button type="submit" class="btn-icon circle" title="Apply Filter"><i
                            class="fas fa-filter"></i></button>
                    @if(request('start_date'))
                        <a href="{{ route('admin.stock_in.index') }}" class="btn-icon circle red" title="Clear"><i
                            ...
                            <tr class="fade-in-row">
                                ...
                                <td>
                                    <div class="actions">
                                        ...
                                        <form id="del-form-{{ $stock->id }}"
                                            action="{{ route('admin.stock_in.destroy', $stock->id) }}" method="POST"
    ...
    <div class="modal-glass">
        ...
        <form id="editForm" method="POST">
            ...
            <div class="row-group">
                ...
                <div class="col-half">
                    <label>Cost</label>
                    <input type="number" name="unit_cost" id="editCost" required step="0.01"
...
<style>
    ...
    .glass-table tbody tr h4,
    .glass-table tbody tr strong {
        color: var(--text-primary);
    }
