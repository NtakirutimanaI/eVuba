...
<div class="sidebar" id="sidebar" style="margin-top:0;">
    <ul class="sidebar-menu">
        ...
        @if($role == 'admin')
            ...
            <li><a href="{{ route('admin.announcements.index') }}"><i class="fas fa-bullhorn"></i> Broadcast Manager</a></li>
        ...
        @if($role == 'customer')
            ...
            <li><a href="{{ route('customer.appointments') }}"><i class="fa fa-calendar-check"></i> Appointments</a></li>
...
.dropdown {
    position: relative;
    z-index: 2000; /* dropdown now floats ABOVE everything */
}
