    ...
    <div class="pro-header">
        ...
        <div class="header-actions" style="display: flex; gap: 1rem; align-items: flex-end;">
            <form action="{{ route('manager.bookings.index') }}" method="GET"
                ...
                <a href="{{ route('manager.bookings.index') }}" class="action-btn"
            ...
            <div style="display: flex; gap: 0.5rem;">
                <a id="pdfReportBtn" data-base-url="{{ route('manager.bookings.generateReport') }}"
                ...
                <a id="excelReportBtn" data-base-url="{{ route('manager.bookings.generateReport') }}"
                            ...
                            <td>
                                <div style="display: flex; gap: 0.4rem; justify-content: flex-end;">
                                    @if($booking->status !== 'approved' && $booking->status !== 'completed')
                                        <form
                                            action="{{ route('manager.bookings.updateStatus', ['booking' => $booking->id, 'status' => 'approved']) }}"
                                            method="POST">
                                            @csrf
                                    ...
                                    @if($booking->status !== 'completed')
                                        <form
                                            action="{{ route('manager.bookings.updateStatus', ['booking' => $booking->id, 'status' => 'completed']) }}"
                                            method="POST">
                                            @csrf
                                    ...
                                    <a href="{{ route('manager.bookings.reschedule', $booking->id) }}" class="action-btn"
                                        title="Reschedule"
                                    ...
                                    <form
                                        action="{{ route('manager.bookings.updateStatus', ['booking' => $booking->id, 'status' => 'rejected']) }}"
                                        method="POST">
                                        @csrf
                                    ...
                                    <form
                                        action="{{ route('manager.bookings.updateStatus', ['booking' => $booking->id, 'status' => 'cancelled']) }}"
