...
<head>
    ...
    <style>
        ...
        .status-badge { padding: 4px 8px; border-radius: 20px; font-size: 9px; font-weight: bold; text-transform: uppercase; }
        ...
        .summary-box { text-align: right; margin-top: 20px; padding-top: 15px; border-top: 2px solid #e2e8f0; }
        .summary-item { font-size: 16px; font-weight: 800; color: #1e293b; }
...
<body>
        ...
        <tbody>
            ...
            @forelse($stockOuts as $out)
                ...
                <tr>
                    ...
                    <td class="text-right" style="font-weight: bold;">{{ number_format($out->quantity * $out->unit_price, 0) }}</td>
                    <td>
            ...
            @empty
                <tr>
                    <td colspan="8" style="text-align: center; padding: 40px; color: #94a3b8;">No distribution entries found.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="summary-box">
        <div class="summary-item">
            <span style="color: #64748b; font-size: 12px; font-weight: normal; margin-right: 15px;">TOTAL DESPATCH VALUATION</span>
            FRW {{ number_format($totalRevenue, 0) }}
        </div>
    </div>

    <div class="footer">
        This document is an official record of distribution. Generated via eVuba Intelligence Dashboard. &copy; {{ date('Y') }} eVuba.
    </div>
</body>
</html>
