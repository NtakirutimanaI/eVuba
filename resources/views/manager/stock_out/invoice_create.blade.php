...
<style>
body { background:#f4f6f8; font-family:Arial,sans-serif; margin:0; padding:0; font-size:13px; }
.invoice-container { width:70%; margin-left:17%; margin-top:40px; background:white; padding:20px; border-radius:8px; box-shadow:0 1px 4px rgba(0,0,0,0.1); }
h2 { font-size:20px; margin-bottom:15px; }
select, input { width:100%; padding:7px; margin-bottom:8px; border:1px solid #ccc; border-radius:6px; font-size:13px; }
.add-btn { padding:7px 12px; background:#007bff; border:none; color:white; border-radius:6px; cursor:pointer; }
...
.total-box { margin-top:20px; padding:15px; background:#f1f1f1; border-radius:8px; font-size:14px; }
.submit-btn { background:#28a745; padding:10px 20px; color:white; border:none; border-radius:8px; cursor:pointer; margin-top:15px; }
.payment-btn { background:#ffc107; padding:10px 20px; color:white; border:none; border-radius:8px; cursor:pointer; margin-top:10px; }

/* Modal Styles */
.modal { display:none; position:fixed; z-index:999; left:0; top:0; width:100%; height:100%; overflow:auto; background:rgba(0,0,0,0.5); }
.modal-content { background:white; margin:10% auto; padding:20px; border-radius:8px; width:40%; position:relative; }
.close { position:absolute; top:10px; right:15px; color:#aaa; font-size:28px; font-weight:bold; cursor:pointer; }
.close:hover { color:black; }
.payment-method-form { display:none; margin-top:15px; }
.payment-method-form input { width:100%; padding:7px; margin-bottom:8px; border:1px solid #ccc; border-radius:6px; }
</style>
...
<div class="invoice-container">
    ...
    <div class="total-box">
        <p><strong>Total Amount:</strong> <span id="totalAmount">0.00</span> RWF</p>
        <p><strong>Total Revenue:</strong> <span id="totalRevenue">0.00</span> RWF</p>
    </div>
