...
<head>
    ...
    <style>
        ...
        section {
            ...
            /* header height */
            background: white;
            /* to enforce light theme on legacy includes */
            position: relative;
            z-index: 10;
            color: #0f172a;
        }
...
<body>
    ...
    <main id="home" class="hero-section">
        <div class="container">
            ...
            <!-- Title & Tagline -->
            <h1 class="hero-title pt-2">Transforming Ideas Into <br><span>Digital Reality</span></h1>

            <p class="hero-subtitle">
                Streamlined Business Management Solution. Elevate your operations with our enterprise-grade tools.
            </p>
            ...
            <div class="d-flex justify-content-center gap-3 mb-4">
                @if (Route::has('login'))
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn-custom btn-secondary-custom">Get Started Today</a>
                        @endif
                    @endauth
                @endif
            </div>
            ...
            <div class="hero-mockup mt-5">
                ...
                @if(file_exists(public_path('images/hero-mockup.png')))
                    <img src="{{ asset('images/hero-mockup.png') }}" class="img-fluid" alt="Dashboard Preview">
                @else
    ...
    <section id="services" style="padding-top: 4rem;">
