            ...
            <div class="mb-3">
                ...
                <select name="service_id" id="service_id" required>
                    ...
                    @foreach($services as $service)
                        <option value="{{ $service->id }}" {{ $booking->employee_id == $service->employee_id ? 'selected' : '' }}>
...
.btn { padding: 6px 12px; border-radius: 4px; border: none; color: white; cursor: pointer; font-size: 13px; }
